...
def main():
    ...
    food_info_path = "/workspace/grits/config/grits.yaml"
    ...
    dir_path = cfg["data_collection"]["dp"]["data_preprocess"]["in_dir"]
    out_dir = cfg["data_collection"]["dp"]["data_preprocess"]["out_dir"]
    food_item = cfg["dp"]["food_item"]
    ...
    for i in range(len(food_item)):
        for j in range(cfg["dp"]["trial_num"]):
