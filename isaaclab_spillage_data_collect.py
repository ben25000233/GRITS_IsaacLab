...
class Spillage_DataCollection():
    ...
    def record_info(self):
        ...
        spillage_vol = self.functions.list_to_nparray(self.spillage_vol)
        scoop_vol = self.functions.list_to_nparray(self.scooped_vol)
        ...
        with h5py.File(f'{output_dir}time_{self.count}.h5', 'w') as h5file:
